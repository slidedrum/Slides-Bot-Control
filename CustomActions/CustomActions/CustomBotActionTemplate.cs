...
namespace BotControl.CustomActions.CustomActions
{
    ...
    public class CustomBotActionTemplate : CustomActionBase
    {
        ...
        public new class Descriptor : CustomActionBase.Descriptor
        {
            ...
            public override PlayerBotActionBase CreateAction()
            {
                ...
                return new CustomBotActionTemplate(this);
            }
        ...
        public CustomBotActionTemplate(Descriptor desc) : base(ClassInjector.DerivedConstructorPointer<CustomBotActionTemplate>())
        {
            ClassInjector.DerivedConstructorBody(this);
