...
namespace BotControl.CustomActions.CustomActions
{
    ...
    public class CustomBotActionRefillTurret : CustomActionBase
    {
        ...
        public new class Descriptor : CustomActionBase.Descriptor
        {
            ...
            public override PlayerBotActionBase CreateAction()
            {
                ...
                return new CustomBotActionRefillTurret(this);
            }
        ...
        [Obsolete]
        public CustomBotActionRefillTurret() : base(ClassInjector.DerivedConstructorPointer<CustomBotActionRefillTurret>())// Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        [Obsolete]
        public CustomBotActionRefillTurret(IntPtr ptr) : base(ptr) // Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        public CustomBotActionRefillTurret(Descriptor desc) : base(ClassInjector.DerivedConstructorPointer<CustomBotActionRefillTurret>())
        {
            ClassInjector.DerivedConstructorBody(this);
