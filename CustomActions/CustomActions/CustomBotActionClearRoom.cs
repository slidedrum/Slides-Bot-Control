...
namespace BotControl.CustomActions.CustomActions
{
    ...
    public class CustomBotActionClearRoom : CustomActionBase
    {
        ...
        public new class Descriptor : CustomActionBase.Descriptor
        {
            ...
            public override PlayerBotActionBase CreateAction()
            {
                ...
                return new CustomBotActionClearRoom(this);
            }
        ...
        public CustomBotActionClearRoom() : base(ClassInjector.DerivedConstructorPointer<CustomBotActionClearRoom>())// Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        public CustomBotActionClearRoom(IntPtr ptr) : base(ptr) // Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        public CustomBotActionClearRoom(Descriptor desc) : base(ClassInjector.DerivedConstructorPointer<CustomBotActionClearRoom>())
        {
            ClassInjector.DerivedConstructorBody(this);
