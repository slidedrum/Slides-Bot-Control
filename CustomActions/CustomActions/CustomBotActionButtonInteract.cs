...
namespace BotControl.CustomActions.CustomActions
{
    ...
    public class CustomBotActionButtonInteract : CustomActionBase
    {
        ...
        public new class Descriptor : CustomActionBase.Descriptor
        {
            ...
            public override PlayerBotActionBase CreateAction()
            {
                ...
                return new CustomBotActionButtonInteract(this);
            }
        ...
        [Obsolete]
        public CustomBotActionButtonInteract() : base(ClassInjector.DerivedConstructorPointer<CustomBotActionButtonInteract>())// Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        [Obsolete]
        public CustomBotActionButtonInteract(IntPtr ptr) : base(ptr) // Don't use this!  Needed for il2cpp nonsense.
        {
            ClassInjector.DerivedConstructorBody(this);

        }// Don't use this!  Needed for il2cpp nonsense.
        public CustomBotActionButtonInteract(Descriptor desc) : base(ClassInjector.DerivedConstructorPointer<CustomBotActionButtonInteract>())
        {
            ClassInjector.DerivedConstructorBody(this);
