...
## Current features: 
 ...
 - Control if and when and where bots are allowed to pick up items
   ...
   - You can change what zones and areas bots are allowed to automtaiclly pick up items in.
...
```
 ...
 - When you tell a bot to fllow you, they will stop all other actions, try this if a bot gets stuck for some reason.
