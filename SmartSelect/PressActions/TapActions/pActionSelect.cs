...
{
    public class pActionSelect : IInputAction
    {
        ...
        public bool Invoke(Component BestComponent)
        {
            ...
            zChatHandler.sendChatMessage("I'm ready.", FriendlyIdentifier + IInputAction.chatPermSuffix, Agent, zStaticRefrences.LocalPlayer);
            return true;
        }
