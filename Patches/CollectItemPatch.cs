...
namespace BotControl.Patches
{
    ...
    internal class CollectItemPatch
    {
        ...
        public static void PostMoveOut(PlayerBotActionCollectItem __instance)
        {
            ...
            travel.Radius = 1.5f;///(__instance.m_desc.TargetContainer != null) ? 1.5f : 0f; // This probably fixes the bug where bots will run back and forth and never reach the item.
